...
var _user$project$Aviso$view = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$html$Html_Attributes$class(
				A2(_elm_lang$core$Basics_ops['++'], 'notification ', model.estilo))
			]),
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$html$Html$text(model.texto)
			]));
};
var _user$project$Aviso$Model = F2(
	function (a, b) {
		return {texto: a, estilo: b};
	});
var _user$project$Aviso$init = F2(
	function (texto, estilo) {
		return A2(_user$project$Aviso$Model, texto, estilo);
	});
var _user$project$Aviso$update = F2(
	function (msg, model) {
		var _p0 = msg;
		return A2(_user$project$Aviso$init, _p0._0, _p0._1);
	});
var _user$project$Aviso$Defina = F2(
	function (a, b) {
		return {ctor: 'Defina', _0: a, _1: b};
	});
...
var _user$project$EscolherPalestra$dmpe = function (msg) {
	var _p0 = msg;
	switch (_p0) {
...
var _user$project$EscolherPalestra$decoderMsgPalestrasEncontradas = A2(
...
var _user$project$EscolherPalestra$init = A5(
	...
	_elm_lang$core$Native_List.fromArray(
		[]),
	_elm_lang$core$Maybe$Nothing);
var _user$project$EscolherPalestra$sessaoExpirada = function () {
	var mbAviso = _elm_lang$core$Maybe$Just(
		A2(_user$project$Aviso$init, 'Sessão expirada! Saia e entre novamente', 'is-danger'));
	return {
		ctor: '_Tuple2',
		_0: _elm_lang$core$Native_Utils.update(
			_user$project$EscolherPalestra$init,
			{mbAviso: mbAviso, expirou: true}),
...
var _user$project$EscolherPalestra$mostrarPalestras = function (palestras) {
	var mostrarRadio = function (palestra) {
		return A2(
			...
			_elm_lang$core$Native_List.fromArray(
				[
					...
					_user$project$EscolherPalestra$PalestraEscolhida(palestra.id))
				]),
			_elm_lang$core$Native_List.fromArray(
				[]));
	};
		...
		return A2(
			...
			_elm_lang$core$Native_List.fromArray(
				[
					...
					_elm_lang$core$Native_List.fromArray(
						[])),
					_elm_lang$html$Html$text('Horário : '),
	...
	var linhas = A2(_elm_lang$core$List$map, montarLinha, palestras);
	return A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
			[
...
var _user$project$EscolherPalestra$escolherPalestra = function (palestras) {
	...
	if (_p1 === true) {
		...
		return A2(
			...
			_elm_lang$core$Native_List.fromArray(
				[
					_user$project$EscolherPalestra$mostrarPalestras(palestras)
				]));
	}
};
var _user$project$EscolherPalestra$HttpRespostaEncontrarPalestras = function (a) {
	return {ctor: 'HttpRespostaEncontrarPalestras', _0: a};
};
var _user$project$EscolherPalestra$HttpErro = function (a) {
	return {ctor: 'HttpErro', _0: a};
};
var _user$project$EscolherPalestra$buscarPalestras = function (ano) {
	var url = A2(
		_evancz$elm_http$Http$url,
		'WSPalestra/encontrarPorAno',
		_elm_lang$core$Native_List.fromArray(
			[
				{
				ctor: '_Tuple2',
				_0: 'ano',
				_1: _elm_lang$core$Basics$toString(ano)
			}
			]));
	return A3(
		_elm_lang$core$Task$perform,
		_user$project$EscolherPalestra$HttpErro,
		_user$project$EscolherPalestra$HttpRespostaEncontrarPalestras,
		A2(_evancz$elm_http$Http$get, _user$project$EscolherPalestra$decoderMsgPalestrasEncontradas, url));
};
				...
				if (_p4.ctor === 'Nothing') {
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								mbAviso: _elm_lang$core$Maybe$Just(
									A2(_user$project$Aviso$init, 'Ano não definido!', 'is-warning'))
							}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				} else {
					var mbAviso = _elm_lang$core$Maybe$Just(
						A2(_user$project$Aviso$init, 'Buscando palestras...', 'is-info'));
					return {
						ctor: '_Tuple2',
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								palestras: _elm_lang$core$Native_List.fromArray(
									[]),
								mbAviso: mbAviso
							}),
		...
		return A2(
			...
			_elm_lang$core$Native_List.fromArray(
				[
					...
					_elm_lang$html$Html_Events$onClick(_user$project$EscolherPalestra$BusquePalestrasDoAno)
				]),
			_elm_lang$core$Native_List.fromArray(
				[
	...
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text('Ano da Semana')
					])),
				A2(
				_elm_lang$html$Html$input,
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$html$Html_Events$onInput(_user$project$EscolherPalestra$DefinaAno)
					]),
				_elm_lang$core$Native_List.fromArray(
					[])),
...
var _user$project$Estudante$decoderVerdadeiro = A3(
	_elm_lang$core$Json_Decode$object2,
	_user$project$Estudante$Estudante,
	A2(_elm_lang$core$Json_Decode_ops[':='], 'matricula', _elm_lang$core$Json_Decode$int),
	A2(_elm_lang$core$Json_Decode_ops[':='], 'nome', _elm_lang$core$Json_Decode$string));
	...
	if (_p0.ctor === 'Nothing') {
		...
		return A2(
			...
			_elm_lang$core$Native_List.fromArray(
				[
					_elm_lang$html$Html_Attributes$class(
					A2(_elm_lang$core$Basics_ops['++'], 'notification ', _p1.tipo))
				]),
			_elm_lang$core$Native_List.fromArray(
				[
					_elm_lang$html$Html$text(_p1.msg)
				]));
	}
};
var _user$project$Presenca$drrp = function (msg) {
	var _p2 = msg;
	switch (_p2) {
...
var _user$project$Presenca$decoderRespostaRegistrarPresenca = A2(
	_elm_lang$core$Json_Decode$andThen,
	A2(_elm_lang$core$Json_Decode_ops[':='], 'Msg', _elm_lang$core$Json_Decode$string),
	_user$project$Presenca$drrp);
var _user$project$Presenca$dme = function (msg) {
	var _p3 = msg;
	switch (_p3) {
...
var _user$project$Presenca$decoderMsgEstudante = A2(
	_elm_lang$core$Json_Decode$andThen,
	A2(_elm_lang$core$Json_Decode_ops[':='], 'Msg', _elm_lang$core$Json_Decode$string),
	_user$project$Presenca$dme);
var _user$project$Presenca$Model = F6(
	function (a, b, c, d, e, f) {
		return {palestra: a, estudante: b, matricula: c, mensagem: d, ativo: e, expirou: f};
	});
var _user$project$Presenca$init = A6(_user$project$Presenca$Model, _user$project$EscolherPalestra$init, _elm_lang$core$Maybe$Nothing, _elm_lang$core$Maybe$Nothing, _elm_lang$core$Maybe$Nothing, true, false);
...
var _user$project$Presenca$RegistrePresenca = F2(
	function (a, b) {
		return {ctor: 'RegistrePresenca', _0: a, _1: b};
	});
var _user$project$Presenca$registrarPresenca = function (_p4) {
	var _p5 = _p4;
	var _p6 = {ctor: '_Tuple2', _0: _p5._0, _1: _p5._1};
	if (((_p6.ctor === '_Tuple2') && (_p6._0.ctor === 'Just')) && (_p6._1.ctor === 'Just')) {
		var _p8 = _p6._0._0;
		var _p7 = _p6._1._0;
		var mostrarPalestra = function (palestra) {
			return A2(
				_elm_lang$html$Html$div,
				_elm_lang$core$Native_List.fromArray(
					[]),
			...
			_elm_lang$core$Native_List.fromArray(
				[
					...
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$html$Html$text(
							_elm_lang$core$Basics$toString(_p7.matricula)),
							_elm_lang$html$Html$text(' -- '),
							_elm_lang$html$Html$text(_p7.nome)
						])),
					A2(
					_elm_lang$html$Html$br,
					_elm_lang$core$Native_List.fromArray(
					...
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$html$Html_Attributes$class('button is-primary'),
							_elm_lang$html$Html_Events$onClick(
							A2(_user$project$Presenca$RegistrePresenca, _p8.id, _p7.matricula))
						]),
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$html$Html$text('Registrar')
						]))
				]));
	} else {
		return A2(
...
var _user$project$Presenca$mostrarBotaoPesquisarEstudante = function (mbMatricula) {
	var _p9 = mbMatricula;
	if (_p9.ctor === 'Nothing') {
		return A2(
			_elm_lang$html$Html$div,
...
var _user$project$Presenca$HttpErro = function (a) {
	return {ctor: 'HttpErro', _0: a};
};
	...
	var url = A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				ctor: '_Tuple2',
				_0: 'matricula',
				_1: _elm_lang$core$Basics$toString(matricula)
			}
			]));
	return A3(
		_elm_lang$core$Task$perform,
			...
			return A2(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[])),
						_user$project$Presenca$mostrarBotaoPesquisarEstudante(mbMatricula)
					]));
		}
	});
var _user$project$Presenca$MsgEscolherPalestra = function (a) {
	return {ctor: 'MsgEscolherPalestra', _0: a};
};
var _user$project$Presenca$update = F2(
	function (msg, model) {
		...
		switch (_p11.ctor) {
			case 'Ativar':
				return {ctor: '_Tuple2', _0: _user$project$Presenca$init, _1: _elm_lang$core$Platform_Cmd$none};
			case 'Desativar':
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
			...
			case 'MsgEscolherPalestra':
				var _p12 = A2(_user$project$EscolherPalestra$update, _p11._0, model.palestra);
				var palestra = _p12._0;
				var comando = _p12._1;
				var _p13 = palestra.expirou;
				if (_p13 === true) {
					...
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{palestra: palestra, mensagem: _elm_lang$core$Maybe$Nothing}),
						_1: A2(_elm_lang$core$Platform_Cmd$map, _user$project$Presenca$MsgEscolherPalestra, comando)
					};
				}
			case 'Matricula':
				...
				if (_p14.ctor === 'Ok') {
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								matricula: _elm_lang$core$Maybe$Just(_p14._0),
								mensagem: _elm_lang$core$Maybe$Nothing,
								estudante: _elm_lang$core$Maybe$Nothing
							}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				} else {
					var mensagem = _elm_lang$core$Maybe$Just(
						A2(_user$project$Presenca$Mensagem, 'Digite apenas números', 'is-danger'));
					return {
						ctor: '_Tuple2',
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{matricula: _elm_lang$core$Maybe$Nothing, estudante: _elm_lang$core$Maybe$Nothing, mensagem: mensagem}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				}
			case 'PesquiseEstudante':
				var _p15 = model.matricula;
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								mensagem: _elm_lang$core$Maybe$Just(
									A2(_user$project$Presenca$Mensagem, 'Matrícula não definida', 'is-warning'))
							}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				} else {
					var msg = _elm_lang$core$Maybe$Just(
						A2(_user$project$Presenca$Mensagem, 'Buscando estudante...', 'is-info'));
					return {
						ctor: '_Tuple2',
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{mensagem: msg}),
						_1: _user$project$Presenca$pesquisarEstudante(_p15._0)
					};
				}
			case 'HttpErro':
				var msg = _elm_lang$core$Maybe$Just(
					A2(
						_user$project$Presenca$Mensagem,
				...
				if (_p16.ctor === 'Nothing') {
					...
					if (_p17.ctor === 'Nothing') {
						...
						return {
							...
							_0: _elm_lang$core$Native_Utils.update(
								model,
								{estudante: _p18, mensagem: _elm_lang$core$Maybe$Nothing}),
							_1: _elm_lang$core$Platform_Cmd$none
						};
					}
				}
			case 'RegistrePresenca':
				var url = A2(
					_evancz$elm_http$Http$url,
					'WSPresenca/cadastrar',
					_elm_lang$core$Native_List.fromArray(
						[]));
				var sid = _elm_lang$core$Basics$toString(_p11._0);
				var sm = _elm_lang$core$Basics$toString(_p11._1);
				var corpo = _evancz$elm_http$Http$string(
					A2(
						_elm_lang$core$Basics_ops['++'],
						'matricula=',
						A2(
							_elm_lang$core$Basics_ops['++'],
							sm,
							A2(_elm_lang$core$Basics_ops['++'], '&palestra=', sid))));
				var comando = A3(
					_elm_lang$core$Task$perform,
					_user$project$Presenca$HttpErro,
					_user$project$Presenca$HttpRespostaRegistrarPresenca,
					A3(_user$project$HttpUtil$post$, _user$project$Presenca$decoderRespostaRegistrarPresenca, url, corpo));
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							mensagem: _elm_lang$core$Maybe$Just(
								A2(_user$project$Presenca$Mensagem, 'registrando...', 'is-info'))
						}),
					_1: comando
				};
			default:
				...
				[
					...
					_elm_lang$core$Native_List.fromArray(
						[
							...
							_elm_lang$html$Html_Events$onClick(_user$project$Presenca$Ativar)
						]),
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$html$Html$text('Registrar Presença')
				...
				[
					...
					_elm_lang$core$Native_List.fromArray(
						[
							...
							_elm_lang$html$Html_Events$onClick(_user$project$Presenca$Desativar)
						]),
					_elm_lang$core$Native_List.fromArray(
						[
					...
					A2(
					_elm_lang$html$Html_App$map,
					_user$project$Presenca$MsgEscolherPalestra,
					_user$project$EscolherPalestra$view(model.palestra)),
					A2(
					_user$project$Presenca$escolherAluno,
					_user$project$EscolherPalestra$palestraEscolhida(model.palestra),
					model.matricula),
					_user$project$Presenca$registrarPresenca(
					{
						ctor: '_Tuple2',
						_0: _user$project$EscolherPalestra$palestraEscolhida(model.palestra),
						_1: model.estudante
					}),
...
var _user$project$Relatorios$mostrarEstudantesPresentes = F2(
	function (mbPalestra, mbEstudantes) {
		var _p1 = mbEstudantes;
		if (_p1.ctor === 'Nothing') {
			return A2(
				_elm_lang$html$Html$div,
				_elm_lang$core$Native_List.fromArray(
				...
				return A2(
					...
					_elm_lang$core$Native_List.fromArray(
						[
							...
							_elm_lang$core$Native_List.fromArray(
								[
									_elm_lang$html$Html$text('Resultado')
								])),
							_user$project$Relatorios$mostrarPalestra(_p2._0),
							_user$project$Relatorios$mostrarEstudantes(_p1._0)
						]));
			}
		}
	});
var _user$project$Relatorios$dee = function (msg) {
	var _p3 = msg;
	switch (_p3) {
		case 'EstudantesEncontrados':
			return _elm_lang$core$Json_Decode$maybe(
				A2(
					_elm_lang$core$Json_Decode_ops[':='],
					'estudantes',
					_elm_lang$core$Json_Decode$list(_user$project$Estudante$decoderVerdadeiro)));
		case 'UsuarioNaoLogado':
			return _elm_lang$core$Json_Decode$succeed(_elm_lang$core$Maybe$Nothing);
		default:
			return _elm_lang$core$Json_Decode$succeed(_elm_lang$core$Maybe$Nothing);
...
var _user$project$Relatorios$decoderMsgEstudantesEncontrados = A2(
	_elm_lang$core$Json_Decode$andThen,
	A2(_elm_lang$core$Json_Decode_ops[':='], 'Msg', _elm_lang$core$Json_Decode$string),
	_user$project$Relatorios$dee);
var _user$project$Relatorios$Model = F6(
	function (a, b, c, d, e, f) {
		return {ativo: a, expirou: b, mbAviso: c, palestraEscolhida: d, mbEstudantes: e, mbAviso: f};
	});
var _user$project$Relatorios$init = A6(_user$project$Relatorios$Model, false, false, _elm_lang$core$Maybe$Nothing, _user$project$EscolherPalestra$init, _elm_lang$core$Maybe$Nothing, _elm_lang$core$Maybe$Nothing);
var _user$project$Relatorios$sessaoExpirou = function () {
	var mbAviso = _elm_lang$core$Maybe$Just(
		A2(_user$project$Aviso$init, 'Sua sessão expirou. Saia e faça login', 'is-danger'));
	return {
		ctor: '_Tuple2',
		_0: _elm_lang$core$Native_Utils.update(
...
var _user$project$Relatorios$HttpRespostaEstudantes = function (a) {
	return {ctor: 'HttpRespostaEstudantes', _0: a};
};
var _user$project$Relatorios$HttpErro = function (a) {
	return {ctor: 'HttpErro', _0: a};
};
var _user$project$Relatorios$buscarPresencas = function (idPalestra) {
	var url = A2(
		_evancz$elm_http$Http$url,
		'WSPresenca/encontrarEstudantesPorPalestra',
		_elm_lang$core$Native_List.fromArray(
			[
				{
				ctor: '_Tuple2',
				_0: 'palestra',
				_1: _elm_lang$core$Basics$toString(idPalestra)
			}
			]));
	return A3(
		_elm_lang$core$Task$perform,
		_user$project$Relatorios$HttpErro,
		_user$project$Relatorios$HttpRespostaEstudantes,
		A2(_evancz$elm_http$Http$get, _user$project$Relatorios$decoderMsgEstudantesEncontrados, url));
};
var _user$project$Relatorios$BusquePresencas = {ctor: 'BusquePresencas'};
var _user$project$Relatorios$mostrarBotaoLerPresencas = F2(
	function (mbPalestra, mbEstudantes) {
		var _p4 = {ctor: '_Tuple2', _0: mbPalestra, _1: mbEstudantes};
...
var _user$project$Relatorios$update = F2(
	function (msg, model) {
		...
		switch (_p5.ctor) {
			case 'HttpErro':
				var aviso = A2(_user$project$Aviso$init, 'Erro na resposta enviada pelo servidor', 'is-danger');
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							mbAviso: _elm_lang$core$Maybe$Just(aviso)
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'HttpRespostaEstudantes':
				var _p7 = _p5._0;
				var _p6 = _p7;
				if (_p6.ctor === 'Nothing') {
					return _user$project$Relatorios$sessaoExpirou;
				} else {
					return {
						ctor: '_Tuple2',
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{mbEstudantes: _p7, mbAviso: _elm_lang$core$Maybe$Nothing}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				}
			case 'BusquePresencas':
				var _p8 = _user$project$EscolherPalestra$palestraEscolhida(model.palestraEscolhida);
				if (_p8.ctor === 'Nothing') {
					return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
				} else {
					var mbAviso = _elm_lang$core$Maybe$Just(
						A2(_user$project$Aviso$init, 'Buscando estudantes...', 'is-info'));
					return {
						ctor: '_Tuple2',
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{mbEstudantes: _elm_lang$core$Maybe$Nothing, mbAviso: mbAviso}),
						_1: _user$project$Relatorios$buscarPresencas(_p8._0.id)
					};
				}
			case 'MsgEscolherPalestra':
				var _p9 = A2(_user$project$EscolherPalestra$update, _p5._0, model.palestraEscolhida);
				var novoPalestra = _p9._0;
				var comando = _p9._1;
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{palestraEscolhida: novoPalestra, mbEstudantes: _elm_lang$core$Maybe$Nothing}),
					_1: A2(_elm_lang$core$Platform_Cmd$map, _user$project$Relatorios$MsgEscolherPalestra, comando)
				};
			case 'MsgAviso':
				var _p10 = model.mbAviso;
				if (_p10.ctor === 'Nothing') {
					return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
				} else {
					var novoAviso = A2(_user$project$Aviso$update, _p5._0, _p10._0);
					return {
						ctor: '_Tuple2',
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								mbAviso: _elm_lang$core$Maybe$Just(novoAviso)
							}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				}
		...
		return A2(
			...
			_elm_lang$core$Native_List.fromArray(
				[
					...
					model.mbEstudantes),
					A2(
					_user$project$Relatorios$mostrarEstudantesPresentes,
					_user$project$EscolherPalestra$palestraEscolhida(model.palestraEscolhida),
					model.mbEstudantes)
				]));
	}
...
var _user$project$Relatorios$viewMostreAviso = function (mbAviso) {
	...
	if (_p12.ctor === 'Nothing') {
		...
		return A2(
			...
			_user$project$Aviso$view(_p12._0));
	}
};
var _user$project$Relatorios$view = function (model) {
	var _p13 = model.expirou;
	if (_p13 === true) {
...
var _user$project$Main$mostrarPresenca = function (presencaModel) {
	return A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
			[
		...
		_elm_lang$core$Native_List.fromArray(
			[
				A2(
				_elm_lang$html$Html_App$map,
				_user$project$Main$PresencaMsg,
